...
const HotelGallery = ({ 
  ...
  // URLs das imagens hardcoded por enquanto (podem vir dos dados depois)
  const mosaicImages = [
    {
  ...
  return (
    <div className="eva-3-mosaic-gallery w-full relative bg-transparent">
      ...
      <div className="absolute top-4 right-4 z-10">
        <button
          className="bg-white text-blue-900 font-semibold rounded-lg px-4 py-2 hover:bg-orange-500 hover:text-white transition border border-blue-100"
