...
-- Apaguei ORIGEM
INSERT INTO TB_PACOTES (TITULO, DESCRICAO, DESTINO, DURACAO, DATA_DISPONIVEL, VALOR_TOTAL, [QUANTIDADE_MAXIMA], CATEGORIAS, ESTRELAS)
VALUES ('Pacote Cancún', 'Viagem completa para Cancún', 'Cancún', 7, '2025-08-01', 6000.00, 1, 'Internacional,Praia', 4);
...
INSERT INTO DB_DecolaTuor.dbo.TB_PAGAMENTOS
(VALOR, FORMA_DE_PAGAMENTO, DATA_PAGAMENTO, STATUS_PAGAMENTO, ID_RESERVA)
VALUES(6000, 'PIX', '01/06/2025', 'Pago', 1);


INSERT INTO DB_DecolaTuor.dbo.TB_PAGAMENTOS
(VALOR, FORMA_DE_PAGAMENTO, DATA_PAGAMENTO, STATUS_PAGAMENTO, ID_RESERVA)
VALUES(6000, 'PIX', '01/06/2025', 'Pendente', 2);